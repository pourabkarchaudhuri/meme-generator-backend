...
// //To get all the meme by _id
// exports.getMemeById = (req, res) => {
//   memeModel
//     .findOne({ material_id: req.params.id })
//     .then((memeModel) => {
//       if (!memeModel) {
//         return res
//           .status(404)
...
//         .status(200)
//         .json(
//           MessageBuilder(memeModel, false, "Fetched meme successfully")
//         );
//     })
//     .catch((err) => {
//       console.log(err);
...
// Controller for creating a new meme
  ...
  newMeme
    ...
    .then((memeModel) => {
      res
        .status(201)
        .json(
          MessageBuilder(memeModel, false, "Meme created successfully")
        );
    })
    .catch((err) => {
      console.log(err);
